...
<div class="input-group col-xs-12">
    ...
    <input data-target="email" type="text" class="form-control" id="name">
</div>
...
<div class="input-group col-xs-12">
    ...
    <input data-target="position" type="text" class="form-control" id="position">
</div>

<span data-target="add-employee" class="btn btn-default col-xs-12" style="margin: 20px 0;">Add</span>
